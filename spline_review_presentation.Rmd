...
* Continuity conditions at knots, $v$
  ...
  * e.g. continuous at second derivative for natural cubic spline


## Toy Example

A spline function of the variable $X$, $f(X)$, of order $m=0$ with $k=2$ knots and no continuity condition
