...
<!-- Enough comercial and self promotion, lets get to the topic-->
...
* Polynomial regression:
  $$
  y = \beta_0 + \beta_1x + \beta_2 x^2 +\dots + \beta_nx^n + \epsilon
  $$
...
* Can be used in linear regression, generalized linear regression, Cox regression

## Spline Components
* Components:
  * Number of knots, $k$, & their placements
  * Order/degree of the polynomial function, $m$,: doesn't make much difference when reaching the cubic term and above
  * Basis functions: different representations of the spline that have specific mathematical properties, e.g. b-splines basis, Gaussian radial basis, etc.
...
## Natural Cubic Spline
![](Figure/cubic_spline.jpg){height = 40%}
...
# Advanced Topics
## Penalized Spline
* Motivation: to simplify the decision making about the knots
* Idea: 
  * Set the number of knots to a really large value (k=25, 40)
...
* Consult with statisticians when feeling not comfortable doing spline models__
